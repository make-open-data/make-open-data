...
with format_cog_poste as (
    select DISTINCT
        ...
        CASE 
            ...
            WHEN SUBSTRING(LPAD(CAST(code_postal AS TEXT), 5, '0') for 3) IN ('200', '201') THEN '2A' -- Corse
            WHEN SUBSTRING(LPAD(CAST(code_postal AS TEXT), 5, '0') FROM 1 FOR 2) = '20' THEN '2B' -- Corse
